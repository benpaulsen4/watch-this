...
export class ActivityService {
  ...
  async getActivityFeed(
    ...
    const { feedType, limit, cursor, activityTypes, dateFrom, dateTo } = options;
    ...
    return {
      ...
      nextCursor: hasMore ? activities[activities.length - 1].activity.createdAt.toISOString() : undefined,
      hasMore,
    };
  }
...
*This feature document should be updated as the activity feed and social features evolve and new engagement patterns are identified.*