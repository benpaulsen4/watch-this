...
import { Shield, Smartphone, Monitor, AlertCircle, RefreshCw } from 'lucide-react';
...
export function PasskeyDevicesViewer() {
  ...
  const getLastUsedText = (lastUsedAt: string | null) => {
    ...
    if (diffInHours < 168) return `Used ${Math.floor(diffInHours / 24)} days ago`;
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-medium text-gray-100 mb-2">Passkey Devices</h3>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300">
              Passkeys are a secure, passwordless way to sign in using your device&apos;s built-in authentication 
              (like fingerprint, face recognition, or PIN). They&apos;re more secure than passwords and can&apos;t be 
              phished or stolen.
            </p>
          </div>
        </div>
