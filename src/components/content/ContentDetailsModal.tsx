...
export function ContentDetailsModal({
  ...
  const runtime =
    detailedContent && "runtime" in detailedContent
      ...
      : null;
  const seasons =
    detailedContent && "number_of_seasons" in detailedContent
      ? detailedContent.number_of_seasons
      : null;
  const episodes =
    detailedContent && "number_of_episodes" in detailedContent
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 sm:gap-4 mb-4 flex-wrap text-sm sm:text-base">
                  ...
                  {runtime && (
                    <div className="flex items-center gap-1 text-gray-400">
                      ...
                      <span className="text-xs sm:text-sm">{runtime} min</span>
                    </div>
                  )}
                ...
                <Tabs
                  ...
                  className="mb-6"
                >
                  <TabList className="flex border-b border-gray-700 mb-4 overflow-x-auto whitespace-nowrap -mx-3 px-3">
                    <Tab
                      id="overview"
                  ...
                  <TabPanel id="overview" className="focus:outline-none">
                    ...
                    {/* Genres */}
                    {detailedContent?.genres &&
                      detailedContent.genres.length > 0 && (
                        <div className="mb-6">
                          <h3 className="text-lg font-semibold text-gray-100 mb-2">
                            Genres
                          </h3>
